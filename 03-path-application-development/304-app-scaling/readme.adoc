...
Deploy Heapster using the steps described in the link:../../02-path-working-with-clusters/201-cluster-monitoring#installation[Cluster Monitoring] lab. 

Kubernetes 1.8 starts to use Metrics api to expose metrics for HPA. Need to install metrics server for this to work. 

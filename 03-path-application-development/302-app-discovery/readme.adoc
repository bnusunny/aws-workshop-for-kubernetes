...
All configuration files for this chapter are in the `302-app-discovery` directory. Make sure you change to that directory before giving any commands in this chapter.
